...
// defines
#define MODULE_NAME 			"huaweiuv"
#define MODULE_VER			"v001"
#define DXDBG(x)					

#define DEVICE_NAME			"U81XX"
#define OFS_KALLSYMS_LOOKUP_NAME	0xc00cecc8	// kallsyms_lookup_name for Huawei U81XX devices
...
// init module
static int __init huaweiuv_init(void)
{
	...
	standard_clocks = (void*) kallsyms_lookup_name_dx("pll0_245_pll1_768_pll2_1056");
...
static void __exit huaweiuv_exit(void)
{
...
module_init(huaweiuv_init);
module_exit(huaweiuv_exit);

MODULE_DESCRIPTION("Undervoltage module for Huawei U81XX devices");
MODULE_LICENSE("GPL");
