...
static uint8_t touch_key_value_u8120[] = {KEY_HOME, KEY_MENU, KEY_BACK, KEY_SEARCH, KEY_RESERVED};
 ...
 //   if(machine_is_msm7x25_c8500() || machine_is_msm7x25_c8600())
...

    {
...

	    {
		    ...
		    touch_key_value = &touch_key_value_u8120;

		    touch_key_value_num = sizeof(touch_key_value_u8120);
